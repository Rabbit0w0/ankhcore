...
public interface LocationStorage {
   ...
   */
  @Nonnull LocationStorage worldId(@Nonnull UUID worldId);

  /**
   *
   * @return chunk
   */
  @Nonnull ChunkStorage chunk();
   ...
   * @return new instance with new value
   */
  @Nonnull LocationStorage x(int x);
   ...
   * @return new instance with new value
   */
  @Nonnull LocationStorage y(int y);
   ...
   * @return new instance with new value
   */
  @Nonnull LocationStorage z(int z);
  ...
  interface Factory {
     ...
     */
    @Nonnull LocationStorage of(@Nonnull UUID worldId, int x, int y, int z);
     ...
     * @return location storage instance
     */
    @Nonnull LocationStorage of(@Nonnull Location location);
  }
}
