...
class BridgerKey<T>(
  ...
  class Factory : AnkhIocKey.Factory {
    ...
    override fun <T> get(type: Class<T>, annotationType: Class<out Annotation>): AnkhIocKey<T> {
      return BridgerKey(Key.get(type, annotationType))
    }

    override fun <T> get(type: Class<T>, annotation: Annotation): AnkhIocKey<T> {
    ...
    override fun get(type: Type, annotationType: Class<out Annotation>): AnkhIocKey<*> {
      return BridgerKey(Key.get(type, annotationType))
    }

    override fun get(type: Type, annotation: Annotation): AnkhIocKey<*> {
      return BridgerKey(Key.get(type, annotation))
    }
  }
}