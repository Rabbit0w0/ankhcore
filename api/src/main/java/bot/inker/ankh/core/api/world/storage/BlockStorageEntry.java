...
public interface BlockStorageEntry {
  @Nonnull LocationStorage location();
  @Nonnull Key blockId();
  ...
  interface Factory{
    ...
    @Nonnull BlockStorageEntry of(@Nonnull LocationStorage location, @Nonnull Key blockId, @Nonnull byte[] content);
  }

  interface Builder extends IBuilder<Builder, BlockStorageEntry> {
    @Nonnull Builder location(@Nonnull LocationStorage location);
    @Nonnull Builder blockId(@Nonnull Key blockId);
    @Nonnull Builder content(@Nonnull byte[] content);
  }
}
